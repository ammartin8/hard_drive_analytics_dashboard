...
def data_etl_dag_v2():
    ...
    # # === CLEANUP PHASE === TODO: Need to move cleaning processes within last task as they are not reported in UI within dag
    # print("=" * 50)
    # print("[CLEANUP] Starting cleanup of intermediate files...")
    # print("=" * 50)
    # try:
    #     for file in files:
    #         os.remove(file)
    #         print(f"✓ Removed CSV file: {file}")
    # except Exception as e:
    ...
    #         os.remove(data)
    #         print(f"✓ Removed ZIP file: {data}")
    # except Exception as e:
    #     print(f"⚠ Warning: Failed to remove ZIP file {data}: {e}")
